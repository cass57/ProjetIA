...
import awele.bot.BotAriolef.MinNodeAriolef;
...
public class MaxNodeAriolef extends MinMaxNodeAriolef
{
     ...
     */
    MaxNodeAriolef(Board board, int depth, double alpha, double beta)
    {
     ...
     */
    @Override
    protected MinMaxNodeAriolef getNextNode (Board board, int depth, double alpha, double beta)
    {
        return new MinNodeAriolef(board, depth, alpha, beta);
    }
