...
public class MinNodeAriolef extends MinMaxNodeAriolef
{
     ...
     */
    MinNodeAriolef(Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MaxNodeAriolef(board, depth, alpha, beta);
    }
